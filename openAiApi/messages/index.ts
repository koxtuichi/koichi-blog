...
export const systemMessages: ChatCompletionRequestMessage[] = [
  ...
  },
  {
    ...
    「ここはゴミ箱かもしれん。でもリサイクルされて飛び立つやつもいるんだから。」\
    「口だけの君たちには成長してほしいんだよ。」`,
  },
  // {
  //   role: "system",
...
export const userMessage = (
  ...
  return {
    role: "user",
    content: isEng
      ? `I would like to see some recommendations for lucky shoots based on ${number} numbers.`
      : `${number}の数字を元にラッキーナンバーを取得して、${problem}の悩みについて励ましてほしい`,
  };
};
